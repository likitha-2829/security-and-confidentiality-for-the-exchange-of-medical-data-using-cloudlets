...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center"> Welcome to Cloudlet Main  </h2>
		  <p>&nbsp;</p>
		  <p>&nbsp;</p>
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li><strong><a href="c_pat_data.jsp"> Vliew All Patient Cloudlet Data </a></strong></li>
			<li><strong><a href="c_pat_acc_req.jsp"> View Patient Data Access Request and Authorize </a></strong></li>
			<li><strong><a href="c_intr_details.jsp"> View All Cloudlet Intruders Details </a></strong></li>
