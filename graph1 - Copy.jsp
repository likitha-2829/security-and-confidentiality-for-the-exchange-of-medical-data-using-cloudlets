...
try
{
	...
	for(int t=0;t<usual_sym.length;t++)
	{
	  ...
	  while ( rs.next() ) 
	  {
		...
		s1=rs.getString(15);
				...
				String decs1 = new String(Base64.decode(s1.getBytes()));
		
		   String[] str = decs1.split(",");
		   for(int k=0;k<str.length;k++)
		   {
		     if(str[k].equalsIgnoreCase(usual_sym[t]))
		     {
		      count++;
		     }
		   }
