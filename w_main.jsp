...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center"> Welcome to Wearable Device Main  </h2>
		  <p>&nbsp;</p>
          ...
          <p align="center"><img src="images/img1.jpg" width="521" height="191" /></p>
        </div>
        </div>
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu style6">
            <li><a href="w_pat_to_cloud.jsp"> Collect Patient Data and Upload to Cloudlet </a></li>
